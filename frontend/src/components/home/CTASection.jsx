    ...
    <div className="w-full py-12 xsm:py-16 sm:py-20 md:py-24 3xl:py-28 px-3 xsm:px-4 sm:px-8 md:px-12 relative">
      <div className="max-w-4xl 3xl:max-w-5xl mx-auto text-center relative z-10">
        ...
        <AnimatedText
          ...
          className="hero-text text-2xl xsm:text-3xl sm:text-4xl md:text-5xl 3xl:text-6xl font-extrabold mb-6"
          delay={0}
          stagger={0.03}
        />
        <AnimatedText
          ...
          className="text-base xsm:text-lg sm:text-xl 3xl:text-2xl text-(--text-muted) max-w-2xl 3xl:max-w-3xl mx-auto mb-8 xsm:mb-10 leading-relaxed font-medium"
          delay={0.2}
          stagger={0.015}
          yOffset={15}
        />
