        ...
        <div className="flex-1 min-w-0 flex flex-col gap-12">
          {PRIVACY_SECTIONS.map((section, sectionIdx) => (
            <section key={section.id} id={section.id} className="scroll-mt-24 4xl:scroll-mt-36">
              ...
              <div className="flex flex-col gap-7 pl-0 sm:pl-7">
                {section.subsections.map((sub) => (
                  <div key={sub.id}>
                    ...
                    {/* Table */}
                    {sub.table && <PrivacyTable table={sub.table} />}

                    {/* List */}
                    {sub.list && <PrivacyList list={sub.list} />}
              ...
              {sectionIdx < PRIVACY_SECTIONS.length - 1 && (
                <div
