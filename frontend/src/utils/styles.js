export const CARD_HOVER =
  "group relative isolate z-0 overflow-hidden transition-all duration-300 md:hover:-translate-y-1 md:hover:shadow-[0_12px_28px_rgba(37,99,235,0.12)] dark:md:hover:shadow-[0_12px_28px_rgba(59,130,246,0.15)]";

export const CARD_HOVER_SUBTLE =
  "group relative isolate z-0 overflow-hidden transition-all duration-300 md:hover:shadow-[0_8px_24px_rgba(37,99,235,0.08)] dark:md:hover:shadow-[0_8px_24px_rgba(59,130,246,0.12)]";
